...
#ifndef HOMOOGENEOUS_PAYDA_H_
#define HOMOOGENEOUS_PAYDA_H_
...
static void Homogeneous_PayDA_Scenario(int interferer)
{
	bool DEBUG = false;
	...
	// APPLICATIONS
	int nb_volt_control = 0;
	int nb_crash_avoidance = 0;
	int nb_rt_iperf = 1;
